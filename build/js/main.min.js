...
var body = document.querySelector('body'); // body.classList.remove('nojs');
...
var accordions = document.querySelectorAll('[data-accordion-menu]');
...
function closeAccordion() {
  accordions.forEach(function (child) {
